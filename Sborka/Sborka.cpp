...
// Sborka.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSborkaApp, CWinApp)
...
// Единственный объект CSborkaApp

CSborkaApp theApp;


// Инициализация CSborkaApp

BOOL CSborkaApp::InitInstance()
{
